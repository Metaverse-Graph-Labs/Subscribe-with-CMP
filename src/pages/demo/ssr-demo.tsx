...
const mockGetPosts = (userId: string | null) => {
	return Promise.resolve([{ title: 'An Example Post', content: 'Hello from Clerk + Next.js', userId }])
}

export const getServerSideProps = async ({ req, resolvedUrl }: any) => {
		...
		<div className={styles.container}>
			<main className={styles.main}>
				...
				<p className={styles.description}>
					This page and any displayed data are fully rendered on the server side. Reload this page to try it
					out.
				</p>
				...
				<div className={styles.preContainer}>
					...
					<p className={styles.instructions}>
						`<strong>getServerSideProps</strong>` uses `<strong>getAuth</strong>` to get the userId and
						fetch the posts from a remote database
					</p>
					<pre>
				...
				<div className={styles.preContainer}>
					...
					<p className={styles.instructions}>
						Using <strong>{`clerkClient.users.getUser`}</strong> during the SSR request allows all Clerk
